...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['product_type_id', 'name', 'article', 'min_price_partner', 'material_type_id'], 'required', 'message' => 'Поле не заполнено!'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'article' => 'Артикул',
            'min_price_partner' => 'Минимальная стоимость для партнёра',
            'material_type_id' => 'Тим материала',
        ];
    }
